...
@include('partials.page-header')
            ...
            <div id="go" class="block lg:flex flex-wrap m-8 md:m-12 xl:mx-20 xl:my-32">
                ...
                <div class="flex-none w-full lg:w-2/3 mb-8 lg:mb-0 lg:border-solid lg:border-t-2 lg:border-b-2 lg:border-primary">
                    <div class="flex items-center h-full">
                        <div class="flex-1 text-center py-8 md:p-8 xl:p-16">
    ...
    <h3 class="w-full px-8 md:px-12 lg:max-w-5xl lg:mx-auto mb-12 xl:mb-24 text-center leading-normal">
       {{ $relationship_intro->intro }}
    </h3> 

    @if($our_relationships)
        <div class="block lg:flex mb-8 max-w-100 lg:mx-auto xl:mb-32">
            @foreach($our_relationships as $r)
                <div class="w-full lg:w-1/3 px-8 md:px-12 lg:px-16">
