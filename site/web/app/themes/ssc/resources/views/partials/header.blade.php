                ...
                >
                    ...
                    <div class="text-right" x-data="{ 'isContactOpen': false }">
                        ...
                        <ul
                            ...
                            class="absolute top-0 right-0 w-menu h-screen bg-primary text-white list-none text-right pt-48"
                            style="z-index: 9999"
                        >
                            <div class="p-8 lg:px-16 py-0">
                                <p class="text-2.5xl text-left text-white mb-12">Contact us today!</p>
